...
import org.example.exchange.FileMessage;
...
public class MainPanelController implements Initializable {
    ...
    private CSS2Properties soundOfFolderOpening;
            ...
            if (listOfLocalElements.getSelectionModel().getSelectedItems().size() == 1) {
                ...
                if (pathToClickedFile.isDirectory()) {
                    ...
                    if (nextDirectory.length == 0) {
                        ...
                        playSoundOfFolderOpening(soundOfFolderOpening);
    ...
    public void playSoundOfFolderOpening(CSS2Properties soundOfFolderOpening) {
        soundOfFolderOpening.setVolume(String.valueOf(0.2));
        soundOfFolderOpening.getClip();
    }
